"""Modules for handing crystallographic lattice-parameters. modified from Jarvis-tools"""
...
def lattice_coords_transformer(old_lattice_mat=None, new_lattice_mat=None, cart_coords=None):
    """Transform coords to a new lattice."""
    if cart_coords is None:
        cart_coords = []
    if new_lattice_mat is None:
        new_lattice_mat = []
    if old_lattice_mat is None:
        old_lattice_mat = []
